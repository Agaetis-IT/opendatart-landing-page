    ...
    <div className={classes.root}>
      <Container maxWidth="md">
        ...
        <Typography>
          ...
          {' '}<b>Nous proposons de mettre en forme ces données sur des posters, t-shirts ou tableaux encadrés, pour un prix allant de 10 à 20€ environ.</b> Si vous êtes intéressé vous pouvez entrer votre addresse e-mail un peu plus bas sur cette page.<br/><br/>
          ...
          Vous pouvez voir le rendu dans la galerie ci-dessus. 
          <br/><br/>
